...
<img src="docs/images/github_visual.png" width="700" alt="OKAN OGP">
...
| 新規登録画面                                                                                                 | ログイン画面                                                                                                 |
| ----------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------- |
| ![新規登録画面](docs/images/signup.png)  | ![ログイン画面](docs/images/login.png) |
| メールアドレスとパスワードで新規登録できます。Googleログイン・LINEログインにも対応しています。 | 登録したメールアドレスとパスワード、またはソーシャルアカウントでログインできます。 |

| アカウント設定画面                                                                                                  | 薬の登録画面                                                                                                     |
| -------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------ |
| ![アカウント設定画面](docs/images/edit_account.png) | ![薬の登録画面](app/assets/images/how_to_use/new_medicine.png) |
| メールアドレスやパスワード変更、アカウント削除などの設定ができます。 | 薬名、1回の服薬量、1日の服用回数、処方量、処方日を登録できます。 |

| 薬の一覧画面                                                                                                    | 薬の詳細画面                                                                                                      |
| ---------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------- |
| ![薬の一覧画面](docs/images/index_medicine.png) | ![薬の詳細画面](docs/images/show_medicine.png) |
...
| 今日の在庫表示機能                                                                                                               | 予想在庫表示画面                                                                                                     |
| ------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------ |
| ![今日の在庫表示画面](app/assets/images/how_to_use/calendar.png)           | ![予想在庫表示画面](app/assets/images/how_to_use/medicine_stock.png) |
| 毎日夜12時に、前日に服薬した薬を量を自動で減算し、正確な今日の在庫数を表示します。また、カレンダーには在庫切れ予定日や通院予定日が表示されます。 | カレンダーの日付をクリックするとその日の予想在庫数を表示します。 |

| 病院情報登録画面                                                                                                     | 病院情報一覧画面                                                                                                      |
| ------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------- |
| ![病院情報登録](app/assets/images/how_to_use/new_hospital.png) | ![病院情報一覧](docs/images/index_hospital.png) |
| 病院名、メモ、診察時間などの情報を登録できます。 | 登録した病院の一覧を確認できます。 |

| 病院情報詳細画面                                                                                                     | 通院予定登録面                                                                                                      |
| ------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------- |
| ![病院情報詳細](app/assets/images/how_to_use/show_hospital.png) | ![通院予定登録](app/assets/images/how_to_use/consultation_schedule.png) |
| 病院名、メモ、診察時間などの情報を登録できます。 | 次回通院予定日を登録できます。病院詳細画面で日時を選択すると、カレンダーに自動反映されます。 |

| LINE通知設定画面                                                                                                                                                             |  LINE受信画面 面                                                                                              |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------- |
| ![LINE通知設定画面](app/assets/images/how_to_use/edit_notification.png)                                                                 | ![ LINE受信画面](docs/images/line_message.png) |
| LINE連携を行い、通知タイミングを設定できます。薬の在庫が減った時、通知予定が近づいた時、何日前に通知するのかを設定できます。 | 設定した条件に応じてLINEで通知が届きます。薬の在庫状況や通院予定日を忘れずに確認できます。|
...
### 画面遷移図
[Figmaで画面遷移図を表示](https://www.figma.com/design/TKYTGl8lAQCmwPjlHiZIoV/%E9%80%9A%E9%99%A2%E7%AE%A1%E7%90%86%E3%82%A2%E3%83%97%E3%83%AA%E3%80%80%E7%94%BB%E9%9D%A2%E9%81%B7%E7%A7%BB%E5%9B%B3?node-id=0-1&p=f&t=oTOPyTQU20oXrSg8-0)
